...
<!DOCTYPE html>
  ...
  <body>
     <center><h1>Hasil Nilai Ujian Nasional </h1></center>
  ...
  <div>
     ...
     <br/><center><a href="form_input.php"><button class="btn btn-success">Tambah Siswa</button></a>
<a href="../index.php"><button class="btn btn-info">Logout</button></a></center>
...
<?php
  ...
  ?>
      ...
      <tr>
          ...
          <td>
            <!--id= diambil dari id GET di file ubah dan hapus-->
          <a href="ubah_data.php?id_siswa=<?php echo $nilai['id_siswa'];?>" class="btn btn-success">Edit</a> |
          <a href="hapus.php?id_siswa=<?php echo $nilai['id_siswa'];?>" class="btn btn-danger" onclick="return confirm('Anda Yakin Ingin Hapus?')">Hapus</a>
          </td>
      </tr>
        <?php endforeach; ?>
